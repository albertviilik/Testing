...
async function quickstart(
  ...
  await storage.bucket(bucketName).upload('imgdrg.mp3', {
  ...
  console.log(`${'imgdrg.mp3'} uploaded to ${bucketName}.`);
	await storage.bucket(bucketName).file('imgdrg.mp3').makePublic();
	// console.log(getPublicUrl('imgdrg.mp3'));
}
